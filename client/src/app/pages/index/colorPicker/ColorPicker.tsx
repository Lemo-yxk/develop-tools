...
export default class ColorPicker extends Component {
	componentDidMount() {
		...
		// ipc.on("mouseMove", (e: any, data: any) => this.mouseMove(data));
		// ipc.on("keyUp", (e: any, data: any) => this.keyUp(data));
	}

	componentWillUnmount() {
		// ipc.send("resetWindow");
		// ipc.send("stop");
				...
				>
					...
					<div className={"history"}>
						{this.state.history.map((e) => (
							<Paper
								key={Math.random()}
								onClick={() => this.setState({ selectedColor: e })}
